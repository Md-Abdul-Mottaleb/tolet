                ...
                <div class="login ">
                    <form id="">
                        ...
                        <div class="form-group">
                          ...
                          <input type="Full Name" class="form-control" id="exampleFormControlInput1" placeholder="">
                        ...
                        <div class="form-group">
                          <label for="exampleFormControlTextarea1">House Address</label>
                        ...
                        <div class="form-group">
                            ...
                            <!-- <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea> -->
                            <input type="file" class="form-control" id="exampleFormControlInput1" placeholder="upload your image">
                          </div>
                          <div class="form-group">
